        ...
        if (type === 'all' || type === 'food') {
            ...
            if (filters.attributes) {
                const attributes = await FoodAttribute.find({
                    _id: {
                        $in: Array.isArray(filters.attributes) ?
                ...
                if (allergens.length && specifications.length)
                    filters = {
                        $and: [{
                                ...filters,
                                attributes: {
            ...
            foodDocuments.where('type', { $ne: drinkType._id });
            ...
            const menus = (
                ...
                .map((e) => ({
                    ...
                    content: {
                        ...
                        foods: e.foods.map(({ food: f, additionalPrice }) => ({
                            food: {
                                ...f,
